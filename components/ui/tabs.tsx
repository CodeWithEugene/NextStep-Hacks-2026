...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg bg-zinc-900 p-1 text-muted-foreground border border-zinc-800",
      className
    )}
    {...props}
  />
